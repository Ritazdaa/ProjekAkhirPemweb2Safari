...
<body>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr id="salary-<?php echo e($salary->id); ?>" data-id="<?php echo e($salary->id); ?>" data-nama="<?php echo e($salary->nama); ?>" data-gaji-pokok="<?php echo e($salary->gaji_pokok); ?>" data-tunjangan="<?php echo e($salary->tunjangan); ?>" data-transport="<?php echo e($salary->transport); ?>" data-lembur="<?php echo e($salary->lembur); ?>">
                            ...
                            <td>
                                <button class="btn btn-warning detail-btn" data-row-id="salary-<?php echo e($salary->id); ?>">Detail</button> <!-- Tombol Detail berwarna kuning -->
                                <button class="btn btn-primary edit-btn" data-row-id="salary-<?php echo e($salary->id); ?>">Edit</button>
                                <button class="btn btn-danger delete-btn" data-row-id="salary-<?php echo e($salary->id); ?>">Hapus</button>
                            </td>
                        </tr>
                        <?php
                            $n++;
    ...
    <div class="add-modal" id="add-modal">
        <div class="add-content">
            ...
            <form id="add-form" method="POST" action="<?php echo e(route('informasi.gaji.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
...
</html><?php /**PATH C:\xampp\htdocs\projekakhir\resources\views/informasi.blade.php ENDPATH**/ ?>