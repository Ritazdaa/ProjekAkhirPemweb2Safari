            ...
            <div class="container mt-3">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <form id="absenForm" action="<?php echo e(route('absen.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <!-- Input form -->
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nip" name="nip" value="<?php echo e(Auth::user()->nip); ?>" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="jabatan" class="form-label">Jabatan</label>
                                <input type="text" class="form-control" id="jabatan" name="jabatan" value="<?php echo e(Auth::user()->jabatan); ?>" readonly>
                            </div>
                            <div class="mb-3">
...
</html><?php /**PATH C:\xampp\htdocs\projekakhir\resources\views/absen_karyawan.blade.php ENDPATH**/ ?>