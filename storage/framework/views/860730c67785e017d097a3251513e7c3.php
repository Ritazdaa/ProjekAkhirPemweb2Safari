            ...
            <div class="col-md-8 offset-md-2">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text"><strong>Nama:</strong> <?php echo e($user->name); ?></p>
                        <p class="card-text"><strong>Email:</strong> <?php echo e($user->email); ?></p>
                        <p class="card-text"><strong>NIP:</strong> <?php echo e($user->nip); ?></p>
                        <p class="card-text"><strong>Jabatan:</strong> <?php echo e($user->jabatan); ?></p>
                        <a href="<?php echo e(route('dashboard.index')); ?>" class="btn btn-primary">Kembali ke Dashboard</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\projekakhir\resources\views/profil.blade.php ENDPATH**/ ?>